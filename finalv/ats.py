...
st.sidebar.markdown('<center> Get summaries for news articles, wikipedia pages, blogs, youtube videos, etc.</center>',unsafe_allow_html=True)
st.sidebar.markdown('<center> <h3>Mohammed Safi Ammar (160117733032)</h3></center>',unsafe_allow_html=True)
...
no_of_sentences = st.number_input('Choose the no. of sentences/words in the summary: ', min_value = 1)
